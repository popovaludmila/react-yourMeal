...
import logoText from "../../images/bigLogoText.svg";
        ...
        <div className="container">
          <div className={footerStyles.contacts}>
            <div className={footerStyles.logo}>
                <img className={footerStyles.logo_text} src={logoText} alt="YourMeal" width="229" height="37" />
                <img src={logo} alt="Логотип бургерной" width="58" height="56" />  
              </div>
              <div className={footerStyles.tel}>
                <p className={footerStyles.text}>Номер для заказа</p>
                <div className={footerStyles.phone} >
                  ...
                  <a className={footerStyles.number} href="tel:+7(930)833-38-11">+7(930)833-38-11</a>
                </div>
              </div>
              <div >
                <p className={footerStyles.text}>Мы в соцсетях</p>
                <ul className={footerStyles.social}>
                  <li className={footerStyles.social_item}>
                    <a href="#1">
              ...
              <div className={footerStyles.copyright}>
                ...
                <span className={footerStyles.author}>Design: Anastasia Ilina</span>
              </div>         
          </div>
        </div>
    </footer>
